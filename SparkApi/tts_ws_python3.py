...
class Ws_Param(object):
    ...
    def on_open(self, ws):
        ...
        #     print("------>开始发送文本数据")
        #     ws.send(d)
        #     if os.path.exists('./example/SparkApi/demo.pcm'):
        #         os.remove('./example/SparkApi/demo.pcm')
...
def text2tts(text):
    # 测试时候在此处正确填写相关信息即可运行
    wsParam = Ws_Param(APPID='42d65636',
                        APISecret='MTNjMmRmMjYzMmJkODg2M2FhZmEzMDU5',
                       APIKey='1736cac2e4499d896fdceba21e9df8f7',
                       Text=text)
